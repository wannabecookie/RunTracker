...
class _StartRunScreenState extends State<StartRunScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        backgroundColor: ui.Color.fromARGB(255, 61, 7, 7),
        body: SafeArea(
          bottom: false,
          child: Column(
  ...
  _timerAndDistance(double fullwidth) {
    return Container(
      ...
      width: fullwidth,
      color: ui.Color.fromARGB(255, 61, 7, 7),
      child: Column(
        mainAxisSize: MainAxisSize.max,
        children: [
          Row(
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      _textContainer((kmSelected) ? "KM" : "Mile"),
                    ],
                  ),
                ),
                Expanded(
                              ...
                              decoration: BoxDecoration(
                                  boxShadow: [
                                    BoxShadow(
                                      ...
                                      spreadRadius: 1,
                                      blurRadius: 50,
                                      color: ui.Color.fromARGB(144, 0, 0, 0),
                                    ),
                                  ],
                                  gradient: LinearGradient(
                                    colors: [
                                      ui.Color.fromARGB(255, 255, 60, 60),
                                      ui.Color.fromARGB(255, 127, 0, 0)
                                    ],
                                  ),
                                  borderRadius:
  ...
  void showDiscardDialog() {
    showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: Text("Discard" + " ?"),
            content: Text("AlertForNoLocation"),
            actions: [
              TextButton(
                child: Text("Discard"),
                onPressed: () async {
