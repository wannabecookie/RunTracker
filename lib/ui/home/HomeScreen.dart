...
// import '../../common/commonTopBars/CommonTopBar.dart';
...
class _HomeScreenState extends State<HomeScreen>
  ...
  _getPreference() {
    ...
    targetValueForDistance = Preference.shared
            .getDouble(Preference.TARGETVALUE_FOR_DISTANCE_IN_KM) ??
        0.0;
    walkTime =
        Preference.shared.getInt(Preference.TARGETVALUE_FOR_WALKTIME) ?? 150;
    runTime =
        Preference.shared.getInt(Preference.TARGETVALUE_FOR_RUNTIME) ?? 75;
    prefSelectedDay =
  ...
  _getSumOfLowIntensity() async {
    ...
    moderateIntensityCount =
        await DataBaseHelper.getSumOfTotalModerateIntensity(dates);
  ...
  //             " " +
  //             (isKmSelected
  //                 ? targetValueForDistance.toInt().toString() + " " + "KM"
  //                 : "${Utils.kmToMile(targetValueForDistance).ceil()}  " +
  //                     "Mile"),
  //         style: TextStyle(
  //             color: Colur.txt_grey, fontWeight: FontWeight.w400, fontSize: 18),
  //       ),
  //     ],
  //   );
  // }
  ...
  walkOrRunCount() {
    return Row(
      ...
      children: [
        ...
        //       ),
        //       Text(
        //         walkIntensityCount != null
        //             ? Utils.secToMin(walkIntensityCount!).toStringAsFixed(0) +
        //                 "/"
        //             : "0" + "/",
        //         style: TextStyle(
        ...
        Container(
          child: Row(
            children: [
              ...
              Text(
                highIntensityCount != null
                    ? Utils.secToMin(highIntensityCount!).toStringAsFixed(0) +
                        "/"
                    : "0" + "/",
                style: TextStyle(
        ...
        axes: <RadialAxis>[
          RadialAxis(
              ...
              pointers: <GaugePointer>[
                RangePointer(
                  value: Utils.calculationForHeartHealthGraph(
                      lowIntensityCount ?? 0,
                ...
                GaugeAnnotation(
                    ...
                    widget: Container(
                      child: Column(
                        ...
                        children: [
                          Text(
                            Utils.calculationForHeartHealthGraph(
                                        lowIntensityCount ?? 0,
                                        highIntensityCount ?? 0,
                                        walkTime,
                                        runTime)
      ...
      child: Column(
        children: [
          bestRecordListTile(
              ...
              text: "Longest Distance".toUpperCase(),
              value:
                  (longestDistance != null && longestDistance!.distance != null)
                      ? (isKmSelected)
                          ? longestDistance!.distance.toString()
                          : Utils.kmToMile(longestDistance!.distance!)
                              .toStringAsFixed(2)
                      : "0.0",
              unit: (isKmSelected) ? "KM".toLowerCase() : "Mile".toLowerCase(),
              isNotDuration: true),
          bestRecordListTile(
              img: "ic_best_pace.png",
              text: "Best Pace".toUpperCase(),
              value: (bestPace != null && bestPace!.speed != null)
                  ? (isKmSelected)
                      ? bestPace!.speed!.toStringAsFixed(2)
                      : Utils.minPerKmToMinPerMile(bestPace!.speed!)
                          .toStringAsFixed(2)
                  : "0.0",
              unit: (isKmSelected)
                  ? "MinKm".toLowerCase()
          ...
          bestRecordListTile(
              ...
              text: "Longest Duration".toUpperCase(),
              value:
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              recentActivitiesData[index].speed != null
                                  ? (isKmSelected)
                                      ? recentActivitiesData[index]
                                          .speed!
                                          .toStringAsFixed(2)
  ...
  //         return AlertDialog(
  //           title: Text("PleaseGivePermissionForActivity"),
  //           actions: [
  //             TextButton(
  //               child: Text(
  //                 "Cancel".toUpperCase(),
